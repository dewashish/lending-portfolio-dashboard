...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemPrompt = `You are a senior credit risk analyst and CRO advisor for Avaloura Group, a multi-geography financial holding group with 5 subsidiaries across South Asia, Middle East, Eastern Europe, and Latin America. The group operates in Consumer Finance, Trade Finance, and Corporate Finance.
