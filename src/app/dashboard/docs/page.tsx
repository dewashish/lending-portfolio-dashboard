    ...
    <Box sx={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', p: 3 }}>
      <Card sx={{ maxWidth: 520, width: '100%', p: 5, textAlign: 'center', border: '1px solid', borderColor: 'divider' }}>
        <Stack spacing={3} alignItems="center">
          ...
          <Typography variant="h5" fontWeight={800}>Product Documentation</Typography>
          <Typography variant="body2" color="text.secondary">
            Comprehensive product documentation covering dashboard features, metric definitions,
            risk appetite framework, and user guides will be available here.
          </Typography>
