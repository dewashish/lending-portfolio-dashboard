  ...
  answer: (ctx) => {
    ...
    return {
      ...
      markdown:
        ...
        `- **Seven Credit Card and unsecured Personal Loan** files sourced through the **merchant POS / DSA channel** in **Cairo and Giza** (Beltone Seven, Egypt) contribute **71%** of the incremental ${metric} balances.\n` +
        ...
        `- Cohorts booked **before** the policy change look normal at the same MOB, which rules out a macro-only story. The residual macro effect (inflation-squeezed household cash flows in Greater Cairo) explains under 5%.\n\n` +
        `**Root cause, ranked:** ① March credit-policy relaxation (~55% of excess) ② channel mix shift toward merchant/DSA sourcing (~25%) ③ early-bucket collections capacity (~15%) ④ macro residual (~5%).\n\n` +
        `**What I would do now:** reinstate the 600 score floor for DSA-sourced unsecured lending, cap NTC share per branch, and re-balance early-bucket calling capacity toward Cairo/Giza. The June cohort reaches MOB 3 in the next cycle — that is the first clean read on whether the drift is still compounding.`,
      evidence: {
        title: `Attribution of excess ${metric} — ${cohortShort}`,
        items: [
          { label: 'Seven Credit Card · DSA · Cairo/Giza', value: '38%', share: 100, tone: 'bad' },
          { label: 'Personal Loan unsecured · DSA', value: '33%', share: 87, tone: 'bad' },
          { label: 'Consumer Loan · branch', value: '12%', share: 32, tone: 'warn' },
          { label: 'Secured (Auto, Home Loan)', value: '9%', share: 24, tone: 'neutral' },
      ...
      followUps: [
        {
          ...
          answer: {
            ...
            markdown:
              `**1,247 accounts** sit in the deteriorating pocket (Seven Credit Card / unsecured Personal Loan, DSA-sourced, Cairo & Giza). Top exposures by principal outstanding:\n\n` +
              `| Account | Product | Location | Channel | Tenure | POS (USD) | DPD | Score @ orig. |\n` +
              `|---|---|---|---|---|---|---|---|\n` +
              `| EG-704-88231 | Personal Loan | Cairo — Nasr City | DSA | 24m | 4,820 | 43 | 588 |\n` +
              `| EG-704-87914 | Personal Loan | Giza | DSA | 18m | 4,610 | 37 | 591 |\n` +
              `| EG-709-90112 | Seven Credit Card | Cairo — Maadi | Seven app | 6m | 3,980 | 51 | 586 |\n` +
              `| EG-704-88764 | Personal Loan | Giza — Dokki | DSA | 24m | 3,760 | 34 | 597 |\n` +
              `| EG-709-90548 | Seven Credit Card | Giza | Seven app | 9m | 3,420 | 46 | 585 |\n` +
              `| EG-704-89007 | Personal Loan | Alexandria | DSA | 18m | 3,150 | 32 | 601 |\n` +
              `| EG-709-91203 | Seven Credit Card | Cairo — Heliopolis | Seven app | 6m | 2,980 | 58 | 587 |\n` +
              `| EG-704-89341 | Personal Loan | Giza | DSA | 12m | 2,740 | 39 | 593 |\n\n` +
            ...
            followUps: [
              {
                ...
                answer: {
                  ...
                  markdown:
                    `Done — in the live build this exports a prioritized calling list (CSV/XLSX) to the collections queue, sorted by **POS × DPD momentum**, with agent capacity flags for Cairo and Giza. For this preview, the export is stubbed.\n\n**Suggested batching:** 420 accounts to the Cairo early-bucket team, 310 to Giza, remainder to the central dialer with a Seven in-app nudge campaign.`,
                },
              },
            ],
          },
        ...
        },
        {
          ...
          answer: {
            ...
            markdown:
              `**To:** Group Credit Committee\n**From:** Consumer Risk — Beltone Seven\n**Re:** Early deterioration in post-March unsecured cohorts\n\n` +
              `Recent unsecured cohorts are tracking ~190 bps above benchmark on 30+ at matched MOB. Attribution isolates the excess to DSA-sourced Seven Credit Card and Personal Loan files in Cairo/Giza scored 585–611 — the band opened by the March score-cut relaxation. Early-bucket follow-up also slowed after the July collector reallocation.\n\n` +
              `**Requested decisions:**\n1. Reinstate the 600 score floor for DSA-sourced unsecured lending, effective next cycle.\n2. Cap new-to-credit share at 45% per branch pending revalidation of the application scorecard.\n3. Return 6 FTE of early-bucket calling capacity to Cairo/Giza through Q3.\n\n` +
  ...
  answer: (ctx) => {
    ...
    return {
      ...
      markdown:
        ...
        `- **Credit-ops turnaround stretched.** Median TAT at this stage moved from **1.8 to 4.2 days**; abandonment climbs steeply after 48 hours, especially for Seven app applicants who expect same-day decisions.\n` +
      ...
      followUps: [
        {
          ...
          answer: {
            ...
            markdown:
              ...
              `| Cairo — Nasr City | 74% | 51% | −23pp | e-KYC rejects |\n` +
              `| Giza Centre | 71% | 53% | −18pp | e-KYC rejects |\n` +
              `| Belgrade — Novi Beograd | 70% | 55% | −15pp | TAT abandonment |\n` +
              `| Karachi — Saddar | 69% | 58% | −11pp | DSA doc quality |\n` +
              `| Alexandria | 73% | 63% | −10pp | e-KYC rejects |\n\n` +
        ...
        },
        {
          ...
          answer: {
            ...
            markdown:
              ...
              `1. **Vendor fix (owner: Digital Ops, this week).** Recalibrate image-quality threshold to contract spec; enable client-side capture guidance in the Seven app.\n` +
...
const consumerKpiFpd: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **Seven Credit Card** FPD is running **2.9%** vs 1.6% for branch-sourced Personal Loans — the gap doubled after the March score-cut relaxation.\n` +
      `- 71% of FPD accounts scored **585–611** at origination, the newly opened band.\n` +
      `- Salary-linked products are clean: **Consumer Loan (salary-linked) FPD is stable at 0.8%**, so payroll timing and macro are not the story.\n` +
    ...
    evidence: {
      ...
      items: [
        { label: 'Seven Credit Card · score 585–611', value: '52%', share: 100, tone: 'bad' },
        { label: 'Personal Loan unsecured · DSA', value: '24%', share: 46, tone: 'bad' },
...
const consumerKpiDpd30: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **Beltone contributes 64%** of the group-level increase; Mirabank and Samman are inside their normal corridor, and LuloBank improved.\n` +
    ...
    evidence: {
      ...
      items: [
        { label: 'Beltone Seven', value: '64%', share: 100, tone: 'bad' },
        { label: 'Samman Capital', value: '18%', share: 28, tone: 'warn' },
        { label: "Mirabank", value: '11%', share: 17, tone: 'neutral' },
        { label: 'First Woman Bank', value: '9%', share: 14, tone: 'neutral' },
        { label: 'LuloBank', value: '−2%', share: 3, tone: 'good' },
      ],
    },
  }),
};
...
const consumerKpiNcl: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- Recovery yield on written-off unsecured is **11.2%**, below the 14% plan — the agency handover backlog in Cairo is the main gap.\n\n` +
...
const consumerOverview: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **The cluster to watch:** FPD% and 30+ are moving together in Beltone Seven's unsecured digital segment — that co-movement is the signature of an underwriting change, not noise. Start at **Delinquency → Static Pool** and select the recent vintages.\n` +
      `- **Collections is performing:** cure rates and resolution are flat-to-better; don't spend review time there.\n` +
      `- **Non-starters** ticked up at FWBL but off a small base (worth one question, not a workstream).\n\n` +
      `Everything else on this tab is inside its two-year corridor.`,
    followUps: [
      {
        label: 'Take me through the Beltone Seven cluster',
        answer: {
          reasoning: [{ text: 'Linking FPD, static pool and channel mix for Beltone Seven' }],
          markdown:
...
const consumerProducts: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      `**Seven Credit Card is the outlier on risk; LAP is quietly your best risk-adjusted book.**\n\n` +
      `- **Seven Credit Card:** 30+ momentum is +80 bps/cycle for two consecutive cycles. Its yield still covers the risk (risk-adjusted margin ~9.1%), but the trajectory erodes that in ~3 cycles if unchecked.\n` +
      `- **Personal Loan (unsecured):** deterioration tracks the DSA channel, not the product itself — branch-sourced Personal Loans are stable.\n` +
      `- **LAP:** best risk-adjusted margin (11.4%) with flat delinquency — supports a deliberate mix tilt.\n` +
      `- **Auto Loan / Home Loan:** secured book behaving; LGDs benefit from collateral coverage >140%.\n\n` +
      `**Read:** the product P&L argues for shifting incremental origination toward LAP while the card scorecard is revalidated.`,
    evidence: {
      title: '30+ momentum by product (bps/cycle)',
      items: [
        { label: 'Seven Credit Card', value: '+80', share: 100, tone: 'bad' },
        { label: 'Personal Loan (DSA-sourced)', value: '+45', share: 56, tone: 'warn' },
        { label: 'Consumer Loan', value: '+10', share: 13, tone: 'neutral' },
        { label: 'LAP', value: '+4', share: 5, tone: 'good' },
        { label: 'Auto Loan', value: '−6', share: 8, tone: 'good' },
      ],
    },
  }),
};
  ...
  answer: (ctx) => {
    ...
    return {
      ...
      markdown:
        ...
        `- **Capacity is stretched where it matters.** Beltone early/mid-bucket case loads run **74 accounts/collector** against a ~55 sustainable ceiling; PTP kept-rate in that cell fell 48% → 39% (a fatigue pattern, not a skills gap).\n` +
        `- **Payment friction adds ~90 bps.** Wallet-mandate bounces at Samman and Beltone mean some "delinquents" are willing payers hitting an empty-wallet auto-debit — re-mandated accounts cure at 74%.\n` +
      ...
      followUps: [
        ...
        },
        {
          ...
          answer: {
            ...
            markdown:
              `Adjusted for case mix and load, this is **not** an individual-performance story:\n\n- The bottom-decile collectors are all in the overloaded Cairo/Giza cell — their kept-rates recover to median when load is simulated at ≤55 accounts.\n- Agency **CRS-Cairo** underperforms on chronic accounts (58% of benchmark recovery) — worth a volume shift to the second agency at renewal.\n- Seven in-app nudges outperform dialer calls for card accounts under 15 DPD at ~zero marginal cost; coverage is only 40% — the cheapest win in the stack.`,
          },
        },
      ],
    };
...
const collectionsEfficiency: AvaInsight = {
  ...
  answer: (ctx) => {
    ...
    return {
      ...
      markdown:
        `**${metric} is being dragged by one cell — Beltone mid-bucket — while the rest of the grid holds.**\n\n` +
        `- **Collection efficiency (collected/due) is 94.1% group-wide**, inside the 93–96% corridor; LuloBank leads at 97%.\n` +
        ...
        `**Read:** don't spread capacity — point it. 6–8 FTE into Beltone B2 for 60 days plus a first-cycle-defaulter treatment path buys back the corridor before the post-March inflow wave peaks.`,
      evidence: {
        title: 'Collections grid — deviation vs corridor',
        items: [
          { label: 'Beltone · B2 roll-forward', value: '+340bps', share: 100, tone: 'bad' },
          { label: 'Beltone · B3 stabilization', value: '+120bps', share: 35, tone: 'warn' },
          { label: 'Samman · mandate bounce rate', value: '+90bps', share: 26, tone: 'warn' },
      ...
      followUps: [
        {
          ...
          answer: {
            ...
            markdown:
              `| Payment mode | Share of due | Efficiency | Trend |\n|---|---|---|---|\n| Card auto-debit | 48% | 95.8% | stable |\n| Cash at branch | 27% | 93.2% | stable |\n| Field collection | 14% | 91.0% | improving |\n| Seven in-app | 11% | 96.4% | improving |\n\nThe mandate-bounce issue shows up inside auto-debit: first-attempt success is 88%, but re-presentation within 3 days of salary/wallet inflows recovers most of the gap. Aligning debit timing to income cycles (salary dates, wallet top-up patterns) is worth ~1pp of group efficiency.`,
          },
        },
      ],
    };
...
const consumerCollections: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      `**Resolution is holding everywhere except one cell: bucket-2 roll-forward in Beltone Seven.**\n\n` +
      `- Group-level cure and stabilization rates are within corridor; LuloBank and Mirabank are best-in-class this period.\n` +
      `- The Beltone bucket-2 cell deteriorated 340 bps: case loads there jumped to **74 accounts/collector** (sustainable ceiling ≈ 55) as the post-March inflow wave arrived.\n` +
...
const consumerNonStarters: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- The cluster: **Karachi (FWBL) disbursements** where the wallet payout and the first-instalment mandate were set up in different accounts — customers received funds but the auto-debit hit an empty account.\n` +
      `- A smaller genuine-fraud tail (~9%) sits in Bogotá DSA files with recycled device IDs; that pocket is already flagged to the fraud desk.\n\n` +
...
const consumerTdd: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **Post-disbursal:** utilization checks show **17% of LAP proceeds** at Samman Capital flowing to a different stated purpose; historically that predicts +90 bps of 90+ within a year for the affected accounts.\n` +
      `- All other checks (KYC completeness, collateral perfection, insurance attachment) are inside baseline.\n\n` +
      `**Read:** add a second-line sampling review on DSA income documents and a targeted utilization re-verification for the Samman LAP cohort — both are contained, cheap interventions today; neither will be in six months.`,
  }),
};
...
const overviewHeatmap: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `1. **Beltone (Seven) — consumer credit quality (act now).** The 30+ and EWS cells share one cause: post-March unsecured cohorts. This is the group's only *compounding* red — it worsens each cycle until origination policy changes.\n` +
      `2. **First Woman Bank — FX and country risk (monitor).** The red is macro (PKR depreciation pass-through), not portfolio behavior; local-currency collections are actually outperforming. A hedging decision, not a credit decision.\n` +
      `3. **Samman Capital — provision coverage (verify first).** Coverage reads amber because the last collateral revaluation file is 47 days old — **this may be staleness, not deterioration**. I'd refresh the feed before escalating; ingestion watermarks show Samman is the only lagging source.\n\n` +
      `LuloBank and Mirabank are green across all dimensions and improving.`,
    evidence: {
      title: 'Attention ranking (impact × momentum)',
      items: [
        { label: 'Beltone · consumer 30+ / EWS', value: 'act', share: 100, tone: 'bad' },
        { label: 'FWBL · FX & country risk', value: 'monitor', share: 55, tone: 'warn' },
        { label: 'Samman · provision coverage', value: 'verify data', share: 40, tone: 'warn' },
        { label: "Mirabank · all dimensions", value: 'stable', share: 12, tone: 'good' },
        { label: 'LuloBank · all dimensions', value: 'improving', share: 8, tone: 'good' },
      ],
    },
  }),
};
...
const overviewKpis: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **Group 30+ at 4.1% (+30 bps)** — entirely consumer-driven, and within consumer, entirely Beltone Seven. Trade and corporate books are flat.\n` +
      `- **NPL 2.8%, stable.** The 30+ lift hasn't reached NPL yet; it will in 2–3 cycles if the Beltone cohorts roll — that's the number to defend.\n` +
      `- **Provision coverage 118%** — above the 110% floor even under the stressed roll-forward case.\n` +
      `- **EWS criticals: 3**, all corporate single names at Samman Capital, all already on the watchlist with actions assigned.\n\n` +
      `**One decision matters this cycle:** the Beltone Seven unsecured score floor. Everything else is monitoring.`,
  }),
};
...
const overviewComposition: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **Subsidiary concentration is healthy:** Beltone is the largest book at 34% — high, but below the 40% single-country appetite; HHI is 0.24 and falling as LuloBank scales.\n` +
      `- **Growth quality flag:** the fastest-growing cell (Beltone Seven digital unsecured) is also the deteriorating one — growth and risk are currently the same trade.\n\n` +
      `**Read:** the mix question and the credit-quality question are one question. Tightening the Beltone score floor slows exactly the segment that is pushing you toward the unsecured cap.`,
  }),
};
...
const overviewBusinessLines: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **Consumer:** highest delinquency (4.9% 30+) but also highest risk-adjusted margin (8.7%) — the model works *when underwriting discipline holds*, which is exactly what's being tested at Beltone Seven.\n` +
...
const overviewScorecard: AvaInsight = {
  suggestedQuestions: () => [
    ...
    'Compare Beltone and Mirabank — why the divergence?',
  ],
  answer: () => ({
    reasoning: [
    ...
    markdown:
      `**Health ranking: LuloBank > Mirabank > FWBL > Samman Capital > Beltone (this period).**\n\n` +
      `- **LuloBank** leads on every credit metric — worth studying rather than just celebrating: its digital-first underwriting kept the 612 score floor — the control group for the Beltone experiment.\n` +
      `- **Beltone ranks last purely on early-stage credit metrics** — its franchise strength (scale, deposit base, collections infrastructure) is intact, which is why the fix is policy, not restructuring.\n` +
      `- **The Beltone ↔ Mirabank divergence is the cleanest natural experiment in the group:** same products, same channels available, but Mirabank *didn't adopt* the March score relaxation. Its cohorts aged normally. Adjusted for mix, the policy explains ~85% of the performance gap.\n\n` +
      `**Read:** the scorecard is one row-click away from the answer — Beltone's row, Delinquency tab, recent vintages.`,
  }),
};
...
const originationLos: AvaInsight = {
  ...
  answer: () => ({
    ...
    markdown:
      ...
      `- **Beltone (91% of target):** verification queue (the e-KYC issue). Fix: vendor threshold + SLA.\n` +
      `- **Mirabank (104%):** on plan; no action.\n` +
      `- **Samman Capital (88%):** approval-stage bottleneck — two credit officers on leave; delegation matrix allows temporary limit increases for the branch manager tier.\n` +
      `- **FWBL (96%):** demand-side softness in Karachi amid fuel price pressure; temporary, not structural.\n` +
      `- **LuloBank (101%):** on plan.\n\n` +
      `**Biggest single lever:** the Beltone verification queue — worth ~$780K/month in disbursement, more than all other gaps combined.`,
  }),
};
      ...
      followUps: [
        {
          ...
          answer: {
            ...
            markdown:
              `| Subsidiary | MTD vs target | Binding constraint |\n|---|---|---|\n| Beltone (Seven) | 91% | verification queue (e-KYC) |\n| Mirabank | 104% | none — on plan |\n| Samman Capital | 88% | approval desk staffing |\n| First Woman Bank | 96% | soft demand (Karachi, temporary) |\n| LuloBank | 101% | none — on plan |\n\nThe Beltone fix is worth more than all other gaps combined (~$780K/month of disbursement).`,
          },
        },
      ],
    };
...
const generic: AvaInsight = {
  ...
  answer: (ctx) => ({
    ...
    markdown:
      ...
      `The dominant movement here ties back to the same story I'm tracking across the consumer book: post-March unsecured cohorts in Beltone Seven. This section's contribution is secondary — the primary evidence sits in **Consumer → Delinquency → Static Pool** (select the recent vintages) and **Origination → Funnel**.\n\n` +
