...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      'Consumer Finance: expanded from 8 to 35 product metrics across 6 collapsible groups',
      'Consumer Finance: Secured/Unsecured toggle with product selector for delinquency KPIs',
      'Consumer Finance: AUM-weighted aggregation for rate metrics across subsidiaries',
      'Consumer Finance: Supabase 1000-row pagination fix (fetchAllPages helper)',
      'Corporate Finance: sector breakdown with aligned period formats',
      'Forward Outlook: complete revamp into 4-layer risk framework (Portfolio Health, Stress Heatmap, Scenario Engine, Early Warning & Actions)',
      'Forward Outlook: surfaced 10+ previously hidden chart components (ECL waterfall, sensitivity tornado, CET1 trajectory, migration matrix, PD term structure, roll rate forecast, leading indicators, macro-credit linkage)',
      'Forward Outlook: subsidiary stress scoring heatmap with 5 dimensions and drill-down drawer',
      'Forward Outlook: management action playbook with category filtering and RAG/priority badges',
      'Forward Outlook: Schema V8 migration (subsidiary_stress_scores, management_actions tables)',
      'Corporate Finance: balanced watchlist trigger categories (Financial, Operational, External, Behavioral)',
      'Animated Vanta.js globe background on login and dashboard (dark/light theme support)',
      'Semi-transparent glass-effect AppBar and TabBar with backdrop blur',
    ],
  },
  {
